...
This plugin adds all the features of Woody Addons

## :fire: Installation & Usage

First, install Woody Plugin via the Composer package manager:
...
```json
{
    ...
    "repositories": [
        {
            "type": "vcs",
            "url": "https://github.com/woody-wordpress-pro/woody-plugin"
        }
    ],
    "require": {
        "php": "^7.3",
        "woody-wordpress-pro/woody-plugin": "^1.0.0",
    }
}
```
...
Thank you to all the people who have already contributed to Woody Plugin !
...
Woody Plugin is open-sourced software licensed under the [GPL2](LICENSE).
